...
<?php get_header(); ?>
    ...
    <section class="slide" id="cover">
        ...
        <figure>
            <img class="cover" src="<?php echo get_template_directory_uri(); ?>/pictures/cover.jpg" alt="Hands on the orange typewriter in a park">
    ...
    <section class="slide" id="picture">
        <h2>Pictures</h2>
        <figure>
            <img class="cover" src="<?php echo get_template_directory_uri(); ?>/pictures/picture.jpg" alt="Orange typewriter on a wooden table close-up">
            <figcaption class="copyright right white">
                <a href="https://fiftyfootshadows.net">© John Carey</a>
            </figcaption>
        </figure>
    ...
    <section class="slide" id="see-more">
        <h2 class="shout">
            <img src="<?php echo get_template_directory_uri(); ?>/pictures/shower-logo.svg" alt="Shower logo">
